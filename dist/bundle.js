...
(function (App) {
    ...
    class ProjectState extends State {
        ...
        addProject(title, description, numberOfPeople) {
            const newProject = new App.Project(Math.random().toString().trim(), title, description, numberOfPeople, App.ProjectStatus.Active);
...
(function (App) {
    class Component {
        ...
        attach(insertAtStart) {
            this.hostElement.insertAdjacentElement(insertAtStart ? 'beforeend' : 'beforeend', this.element);
        }
    }
